...
const KNOWN_PERSON_SIGNALS = [
  ...
  // Extra patterns with prepositions and variations
  ...
  'من اهلي','من أهلي','أهل','اهل','عيلة','عيلتي',
  'لولدي','لبنتي','لزوجتي','لزوجي','لجدي','لجدتي',
  'لعمي','لخالي','لعمتي','لخالتي',
  // Common misspellings / dialect
  'اخوي','اخي','اختي','ابوي','امي','صاحبي','رفيقي',
  // Work relationships
  'موظف','موظفة','عامل','عاملة','شغال','شغالة','سايق','سائق',
  // "I know him/her"
  'أعرفه','اعرفه','أعرفها','اعرفها','معروف لي','أعرفهم',
  'شخص اعرفه','شخص أعرفه','شخص أثق به','شخص موثوق',
];
